...
@Singleton
public class BlocXMLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class ExportModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.ExportModel");
	...
	public class ComponentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Component");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Variable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TagElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Tag");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NodesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Nodes");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Node");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Link");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BaliseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.BlocXML.Balise");
	...
	@Inject
	public BlocXMLGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.BlocXML".equals(grammar.getName())) {
				return grammar;
			}

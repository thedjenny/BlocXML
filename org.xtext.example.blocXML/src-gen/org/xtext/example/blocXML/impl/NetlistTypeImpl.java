 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.blocXML.impl.NetlistTypeImpl#getDocname <em>Docname</em>}</li>
 *   <li>{@link org.xtext.example.blocXML.impl.NetlistTypeImpl#getDoctype <em>Doctype</em>}</li>
 *   <li>{@link org.xtext.example.blocXML.impl.NetlistTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.xtext.example.blocXML.impl.NetlistTypeImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetlistTypeImpl extends MinimalEObjectImpl.Container implements NetlistType
{
  ...
  {
    return BlocXMLPackage.Literals.NETLIST_TYPE;
  }
  ...
  public void setDocname(String newDocname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BlocXMLPackage.NETLIST_TYPE__DOCNAME, oldDocname, docname));
  }
  ...
  public void setDoctype(String newDoctype)
  {
    ...
    doctype = newDoctype;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BlocXMLPackage.NETLIST_TYPE__DOCTYPE, oldDoctype, doctype));
  }
  ...
  public EList<Layer> getLayer()
  {
    if (layer == null)
    {
      layer = new EObjectContainmentEList<Layer>(Layer.class, this, BlocXMLPackage.NETLIST_TYPE__LAYER);
    }
    return layer;
  }
  ...
  public NotificationChain basicSetNodes(Nodes newNodes, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BlocXMLPackage.NETLIST_TYPE__NODES, oldNodes, newNodes);
  ...
  public void setNodes(Nodes newNodes)
  {
    if (newNodes != nodes)
    {
      ...
      if (nodes != null)
        msgs = ((InternalEObject)nodes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BlocXMLPackage.NETLIST_TYPE__NODES, null, msgs);
      if (newNodes != null)
        msgs = ((InternalEObject)newNodes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BlocXMLPackage.NETLIST_TYPE__NODES, null, msgs);
      msgs = basicSetNodes(newNodes, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BlocXMLPackage.NETLIST_TYPE__NODES, newNodes, newNodes));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BlocXMLPackage.NETLIST_TYPE__LAYER:
        return ((InternalEList<?>)getLayer()).basicRemove(otherEnd, msgs);
      case BlocXMLPackage.NETLIST_TYPE__NODES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BlocXMLPackage.NETLIST_TYPE__DOCNAME:
        return getDocname();
      case BlocXMLPackage.NETLIST_TYPE__DOCTYPE:
        return getDoctype();
      case BlocXMLPackage.NETLIST_TYPE__LAYER:
        return getLayer();
      case BlocXMLPackage.NETLIST_TYPE__NODES:
